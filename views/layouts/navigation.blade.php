<nav class="lg:flex lg:flex-row lg:justify-between">
    <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-6 h-6 justify-center text-white rounded-sm lg:hidden bg-red-500 hover:bg-red-600" aria-controls="navbar-default" aria-expanded="false">
