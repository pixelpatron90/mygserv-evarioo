                ...
                <div class="sidebar">
                    ...
                    <div class="widget">
                        ...
                        <div class="content">
                            ...
                            <ul class="mt-2">
                                <li class="bg-red-500 odd:bg-primarycolor odd:hover:bg-gray-900 hover:bg-red-600 text-white rounded-md p-2 mb-1">
                                ...
                                <li class="bg-red-500 odd:bg-primarycolor odd:hover:bg-gray-900 hover:bg-red-600 text-white rounded-md p-2 ">
