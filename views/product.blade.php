                ...
                <div class="content-box">
                    ...
                    <div class="flex flex-col gap-2 mt-2">
                        ...
                        <div class="flex flex-col gap-1 group duration-150">
                            @if ($categoryItem->products()->where('hidden', false)->count() > 0 ||
                            $categoryItem->children->count() > 0)
                            ...
                            @if($categoryItem->children->count() > 0)
                            <div
                                class="flex flex-col gap-1 @if(!$hasActiveChild) hidden @endif group-hover:flex transition ease-in-out duration-300">
                                @foreach ($categoryItem->children as $childCategory)
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="content-box h-full flex flex-col">
                            <div class="flex items-center gap-x-3 mb-2">
                                @if($childCat->image)
                                <img src="/storage/categories/{{ $childCat->image }}" class="w-14 rounded-md"
